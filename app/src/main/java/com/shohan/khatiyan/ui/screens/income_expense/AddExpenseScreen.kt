    ...
    Scaffold(
        ...
        Column(
            ...
            KhatiyanOutlinedTextField(
                ...
                onValueChange = {
                    category = it
                    if (it.isNotBlank()) categoryError = null
                },
                label = "ব্যয়ের খাত/ক্যাটাগরি (যেমন: বাজার, খাবার, যাতায়াত) *",
            ...
            KhatiyanOutlinedTextField(
                ...
                label = "স্থান/দোকানের নাম (ঐচ্ছিক)"
            )
            Spacer(modifier = Modifier.height(12.dp))
            ...
            Button(
                onClick = {
                    ...
                    if (category.isBlank()) {
                        categoryError = "ব্যয়ের খাত আবশ্যক"
